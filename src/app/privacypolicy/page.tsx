...
const PrivacyPolicy: React.FC = () => {
  return (
    ...
    <div className="p-6">
      ...
      <p className="text-sm text-gray-600">Last updated: June 19, 2024</p>
      <p className="mt-4">
      ...
      <ul className="list-disc list-inside ml-6 mt-2">
        ...
        <li className="mt-2">
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Blem CRM, Chandaka Industrial Estate Bhubaneswar, Odisha.
          </p>
        </li>
        <li className="mt-2">
          <p>
      ...
      <ul className="list-disc list-inside ml-6 mt-2">
        ...
        <li className="mt-2">
          <strong>For business transfers:</strong> We may share or transfer Your personal information in connection with the evaluation of a merger, consolidation, restructuring, the sale of company assets, financing, or acquisition of
    ...
    <h3 className="text-lg font-semibold mt-4">Security of Your Personal Data</h3>
    <p className="mt-2">
    ...
    <ul className="list-disc list-inside ml-6 mt-2">
      <li className="mt-2">By email: contact@yourdomain.com</li>
      <li className="mt-2">By visiting this page on our website: www.yourdomain.com/contact</li>
      <li className="mt-2">By phone number: +123456789</li>
    </ul>
  </div>
  <Footer />
  </>
